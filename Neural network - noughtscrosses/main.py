...
def ManyGames(user_type_in, model_in, play_start):
	...
	for i in range(int(no_games/2)):
		__, __, game_result = noughtscrosses.PlayGame(user_type_in, model_in, play_start)
...
# Test games
# types_in = {1:'User', 2:'RandSmart'}
# noughtscrosses.PlayGame(types_in,[],1)
# no_games = 25
# obj = "legal moves"
